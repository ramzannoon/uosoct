...
class StudentTermResultLetter(models.TransientModel):
    _name = 'student.term.result.letter.wiz'
    _description = 'Student Term Result Letter'
    ...
    student_term_id = fields.Many2one('odoocms.student.term', 'Student Term', required = True)
    ...
    def print_report(self):
        ...
        return self.env.ref('odoocms_exam.action_report_student_term_result_letter').with_context(landscape=False).report_action(self, data=datas, config=False)
