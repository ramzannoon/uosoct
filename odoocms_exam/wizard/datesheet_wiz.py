...
class DateSheetWiz(models.TransientModel):
    _name = 'datesheet.wiz'
    ...
    def print_report(self):
        ...
        return self.env.ref('odoocms_exam.action_report_datesheet').with_context(landscape=True).report_action(self, data=datas,config=False)
