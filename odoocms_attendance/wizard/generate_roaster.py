	...
	def generate_roaster(self):
		...
		if self.level == 'class' and self.class_ids:
			...
			for class_id in class_ids:
				att_classes += class_id.attendance_roaster(self.term_id, self.date_class, self.date_class_to)
		else:
			...
			for batch in batches:
				att_classes += batch.attendance_roaster(self.term_id, self.date_class,self.date_class_to)
