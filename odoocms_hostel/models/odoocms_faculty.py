...
class OdooCMSFaculty(models.Model):
    ...
    hostel_hist_ids = fields.One2many('odoocms.faculty.hostel.history', 'faculty_id', 'Hostel History')
    special_info_ids = fields.One2many('odoocms.hostel.faculty.special.info', 'faculty_id', 'Special information')
    extra_facility_ids = fields.One2many('odoocms.hostel.extra.facilities', 'faculty_id', 'Extra Items')

    visitor_ids = fields.One2many('odoocms.hostel.visitor', 'faculty_id', 'Visitors')
