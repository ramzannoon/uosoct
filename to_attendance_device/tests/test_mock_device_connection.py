...
class TestAttendanceDeviceConnection(SavepointCase):
    ...
    def test_01_connect_wrong_password(self):
        with self.assertRaises(ValidationError, msg = "test_connect_wrong_password passed"):
    ...
    def test_02_connect_wrong_ip(self):
        with self.assertRaises(ValidationError, msg = "test_connect_wrong_ip passed"):
            self.attendance_device.action_check_connection()
    ...
    def test_03_connect_wrong_port(self):
        with self.assertRaises(ValidationError, msg = "test_connect_wrong_port passed"):
            self.attendance_device.action_check_connection()
    ...
    def test_04_connect_wrong_protocol(self):
        with self.assertRaises(ValidationError, msg = "test_connect_wrong_protocol passed"):
            self.attendance_device.action_check_connection()
    ...
    def test_05_connect_successfully(self):
        with self.assertRaises(UserError, msg = "test_connect_successfully passed"):
            self.attendance_device.action_check_connection()
