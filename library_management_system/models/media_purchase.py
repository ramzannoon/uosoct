...
class OpMediaPurchase(models.Model):
    ...
    _description = "Reference Purchase Request"
    ...
    course_ids = fields.Many2one(
        'odoocms.course', 'Course', required=True, track_visibility='onchange')
    ...
    year_of_publication = fields.Char(string="Year of Publication")
